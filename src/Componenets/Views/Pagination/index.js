 ...
 function Pagination() {
    return (
        <>
            ...
            <div className="flex items-center justify-center m-4   lg:px-0 sm:px-6 px-4 bg-indigo-400">
                <button className="bg-slate-50 m-3 flex justify-center  items-center font-medium py-2 px-4 rounded-full w-full">
                <AiOutlineDropbox className="mr-2"/>    Monetize Your Topics
                    </button>
